					 ...
					 ',
						[
							...
							p(style = 'margin-bottom: 30px; color: #555; line-height: 1.6;',
								[
									'¡Alerta, juguetes! El malvado Emperador Zurg se acerca, ¡y necesitamos cruzar el puente antes de que sea tarde! ',
									br([]),
									'Pero hay un problema: el puente es viejo y solo puede soportar el peso de dos juguetes a la vez. ',
									br([]),
									'Además, necesitan una linterna para ver, y solo tenemos una linterna que deben llevar consigo en cada cruce. ',
									br([]),
									'Para complicar las cosas, el tiempo que tarda el grupo en cruzar es el tiempo del juguete más lento de ese grupo.',
									br([]),
							...
							% --- Contenedor para las tarjetas de personajes (usando Flexbox) ---
								...
								[
									...
									',
										[
											h3(style = 'color: #3498db; margin-bottom: 8px;', ['Buzz']),
											% Nombre de Buzz
							...
							% --- Sección del Boton ---
								...
								[
									...
									a([href = '/reglas.html', style = 'display: inline-block; padding: 15px 30px; background-color: #e74c3c;
									    color: white; text-align: center; text-decoration: none; border-radius: 8px; font-size: 1.1em; 
										transition: background-color 0.3s ease, transform 0.1s ease;'], '¡Ver Reglas del Puente!')])])])]).